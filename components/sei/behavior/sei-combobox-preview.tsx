...
import { focusRing } from "@/components/sei/styles/variants";
import { mockArtistOptions, type ComboOption } from "./behavior-mock";
 ...
 * SEIHouse owns the visual surface. Mock data only — no real search index.
 */
...
export interface SEIComboboxPreviewProps {
  ...
  placeholder?: string;
  options?: ComboOption[];
  /** Optional change handler — receives the selected option id (mock). */
