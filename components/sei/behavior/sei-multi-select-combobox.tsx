...
import { focusRing, seiInteractiveItemVariants } from "@/components/sei/styles/variants";
import { mockVaultTags, type MultiSelectOption } from "./behavior-mock";
 ...
 * React Aria handles the combobox a11y; SEIHouse owns styling. Mock data only.
 *
